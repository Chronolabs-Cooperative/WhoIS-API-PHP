 ...
 */
class APIFormTinymce extends APIEditor
{
    public $language;
    public $width  = '100%';
    public $height = '500px';
    ...
    public function __construct($configs)
    {
        ...
        $this->rootPath = '/class/apieditor/tinymce';
    ...
    public function getLanguage()
    {
        ...
        if (defined('_API_EDITOR_TINYMCE_LANGUAGE')) {
            $this->language = strtolower(constant('_API_EDITOR_TINYMCE_LANGUAGE'));
        } else {
    ...
    {
        if (empty($this->config['fonts']) && defined('_API_EDITOR_TINYMCE_FONTS')) {
            $this->config['fonts'] = constant('_API_EDITOR_TINYMCE_FONTS');
        }
    ...
    {
        return is_readable(API_ROOT_PATH . $this->rootPath . '/tinymce.php');
    }
}
