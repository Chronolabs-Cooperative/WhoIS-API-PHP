...
<head>
    ...
    <title>' . $apiConfig['sitename'] . ' - ' . _LOGGER_DEBUG . ' </title>
    <meta name="generator" content="API" />
    <link rel="stylesheet" type="text/css" media="all" href="' . api_getcss($apiConfig['theme_set']) . '" />
</head>
<body>' . $dump . '
...
if (empty($mode) || $mode === 'queries') {
    ...
    $pattern = '/\b' . preg_quote($apiDB->prefix()) . '\_/i';
